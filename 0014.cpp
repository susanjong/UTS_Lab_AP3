...
{ // blok program dimulai 
   ...
   if (total % 10 == 0) { // untuk validasi kartu tipe, akan memeriksa nilai total setelah operasi checksum habis dibagi 10
    ...
    } else if ((nomorStr.length() == 13 || nomorStr.length() == 16) && (nomorStr.substr(0, 2) == "35")) {
        // Penjelasan bagian else if  ada pakai substr dipakai buat cek apakah dua digit pertama dari nomor kartu adalah "35".
        cout << "JCB" << endl; // jika perintah else if ini terpenuhi maka outputnya ini
    
    } else if ((nomorStr.length() == 13 || nomorStr.length() == 16) && nomorStr[0] == '6') {
        // Penjelasan bagian else if  ada pakai nomorstr[0] dipakai buat cek apakah digit pertama kartu diawali 6 atau bukan
        cout << "DISCOVER" << endl; // jika perintah else if ini terpenuhi maka outputnya ini
      
      } else if ((nomorStr.length() == 14 || nomorStr.length() == 16) && nomorStr[0] == '3') {
        // Penjelasan bagian else if  ada pakai nomorstr[0] dipakai buat cek apakah digit pertama kartu diawali 3 atau bukan
        cout << "DINERS CLUB" << endl; // jika perintah else if ini terpenuhi maka outputnya ini
      
      } else if ((nomorStr.length() == 13 || nomorStr.length() == 15) && (nomorStr.substr(0, 3) == "378")) {
        // Penjelasan bagian else if  ada pakai substr (0,3) dipakai buat cek apakah tiga digit pertama dari nomor kartu adalah "378".
        cout << "AMERICAN EXPRESS CORPROTE" << endl; // jika perintah else if ini terpenuhi maka outputnya ini

      } else if ((nomorStr.length() == 13 || nomorStr.length() == 15) && (nomorStr.substr(0, 2) == "37")) {
        // Penjelasan bagian else if  ada pakai substr dipakai buat cek apakah dua digit pertama dari nomor kartu adalah "37".
        cout << "AMERICAN EXPRESS" << endl; // jika perintah else if ini terpenuhi maka outputnya ini
      } 
